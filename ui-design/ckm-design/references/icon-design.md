...
python3 ~/.claude/skills/ui-design/ckm-design/scripts/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```
...
```bash
python3 ~/.claude/skills/ui-design/ckm-design/scripts/icon/generate.py --list-styles
python3 ~/.claude/skills/ui-design/ckm-design/scripts/icon/generate.py --list-categories
```
